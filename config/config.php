...
$arrDca['es_easysale'] = array(
    'es_product'        => array(
        'tables'        => array('tl_easysale_product', 'tl_easysale_transactions'),
        'icon'          => 'system/modules/es_easysale/assets/img/easysale.png',
        'importdlart'   => array('es_easysale_import', 'importFromDlArt')
    )
);

array_insert($GLOBALS['BE_MOD'], 1, $arrDca);
 ...
 */
$GLOBALS['FE_MOD']['es_easysale']['es_easysale'] = 'tl_easysale_modul';
 ...
 */
$GLOBALS['TL_CTE']['es_easysale']['es_easysale']            = 'tl_easysale_content';
$GLOBALS['TL_CTE']['es_easysale']['tl_easysale_salesite']   = 'tl_easysale_salesite';
 ...
 */
$GLOBALS['TL_HOOKS']['outputFrontendTemplate'][]    = array('tl_easysale', 'hoOutputFrontendTemplate');
$GLOBALS['TL_HOOKS']['replaceInsertTags'][]         = array('tl_easysale', 'replaceEasySaleTags');
 ...
 * EASY SALE SETTINGS
 *
 * Hier werden die Einstellungen fuer die easy sale-Erweiterung festgelegt.
 */

// Felder, die im FE nicht in der Artikelbeschreibung angezeigt werden sollen.
$GLOBALS['EASY_SALE']['BE']['exclude_fields']   = array('PRIMARY', 'id', 'pid', 'sorting', 'tstamp', 'product_path', 'seller_mail', 'addImage', 'alt', 'title', 'size', 'imagemargin', 'imageUrl', 'fullsize', 'caption', 'floating', 'product_active');

// Soll die mitgelieferte CSS-Datei geladen werden?
$GLOBALS['EASY_SALE']['FE']['include_css']      = false;

// In der Artikelüberschrift erst die Artikelnummer, dann die Artikelbezeichnung ausgeben
$GLOBALS['EASY_SALE']['FE']['nummer_first']     = true;

// PayPal-Sandbox benutzen (nur fuer Tests)!
$GLOBALS['EASY_SALE']['PP']['use_sandbox']      = false;

// Debug-Meldungen ausgeben
$GLOBALS['EASY_SALE']['PP']['debug']            = false;

// Formular anzeigen und automatische Weiterleitung abschalten
$GLOBALS['EASY_SALE']['PP']['show_form']        = false;